...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DedicatedMultiCLBService) DeepCopyInto(out *DedicatedMultiCLBService) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DedicatedMultiCLBService.
func (in *DedicatedMultiCLBService) DeepCopy() *DedicatedMultiCLBService {
	if in == nil {
		return nil
	}
	out := new(DedicatedMultiCLBService)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *DedicatedMultiCLBService) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DedicatedMultiCLBServiceList) DeepCopyInto(out *DedicatedMultiCLBServiceList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]DedicatedMultiCLBService, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DedicatedMultiCLBServiceList.
func (in *DedicatedMultiCLBServiceList) DeepCopy() *DedicatedMultiCLBServiceList {
	if in == nil {
		return nil
	}
	out := new(DedicatedMultiCLBServiceList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *DedicatedMultiCLBServiceList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DedicatedMultiCLBServiceSpec) DeepCopyInto(out *DedicatedMultiCLBServiceSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DedicatedMultiCLBServiceSpec.
func (in *DedicatedMultiCLBServiceSpec) DeepCopy() *DedicatedMultiCLBServiceSpec {
	if in == nil {
		return nil
	}
	out := new(DedicatedMultiCLBServiceSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DedicatedMultiCLBServiceStatus) DeepCopyInto(out *DedicatedMultiCLBServiceStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DedicatedMultiCLBServiceStatus.
func (in *DedicatedMultiCLBServiceStatus) DeepCopy() *DedicatedMultiCLBServiceStatus {
	if in == nil {
		return nil
	}
	out := new(DedicatedMultiCLBServiceStatus)
	in.DeepCopyInto(out)
	return out
}
